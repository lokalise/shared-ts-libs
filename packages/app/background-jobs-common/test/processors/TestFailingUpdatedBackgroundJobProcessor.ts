...
import {
  FakeUpdatedBackgroundJobProcessor
} from '../../src/background-job-processor/processors/FakeUpdatedBackgroundJobProcessor.js'
...
> extends FakeUpdatedBackgroundJobProcessor<T> {
